                        ...
                        <div className="row">
                                ...
                                <div className="form-part">
                                    ...
                                    <div className="register-user-form">
                                        <form>
                                            ...
                                            <div className="row"><button type="submit" className="btn mt-3 py-3 w-100 rounded-5 fw-bold btn-primary">Create Account</button></div>
                                        </form>
                          ...
                          c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
                            ...
                            <div className="col-md-6 d-flex  align-items-center flex-column text-center">
                                <p className="mb-0 text-end">Already have an account? <span className="text-primary fw-bold" style={{ cursor: 'pointer' }}>Sign In</span></p>
